        ...
        <Banner.BannerContainer>
            <Banner.BannerList>
                <Banner.Banners ref={(e) => banner.current[0] = e}
                    style={{ background: 'url(./images/staticImages/banner_travel.jpg) center/cover', visibility: 'visible', opacity: '1' }}>
                </Banner.Banners>

                <Banner.Banners ref={(e) => banner.current[1] = e}
                    style={{ background: 'url(./images/staticImages/banner_beach.png) center/cover' }}>
                </Banner.Banners>
